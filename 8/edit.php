	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['save'])){ 
				...
				$update = mysqli_query($link, "UPDATE course SET name='$name', duration='$duration', id_author='$id_author', description='$description', thumbnail='$thumbnail' WHERE id='$id'") or die(mysqli_error()); 
				if($update){
